...
SELECT  c.[customer_id] 
       ...
       ,c.[invoice_print_qty] 
       ,c.[cod_required_flag]
       ,pricing_method_code.[code_description] as [pricing_method_description]
       -- c.[source_price_cd] 
       ,c.[po_no_required] 
...
LEFT JOIN {{ ref('src_code')}} AS pricing_method_code ON  [pricing_method_code].[code_no] = c.[pricing_method_cd]
where c.[delete_flag] <> 'Y'
)

SELECT  *
FROM result_customers 